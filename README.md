...
3. Clone this repo
4. Install node module using the command `npm install`
5. Create a `.env` file using `.env.example` and fill in the values
6. Follows the below script in Create React App to start the application
