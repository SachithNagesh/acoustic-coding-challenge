...
function Footer() {
    ...
    return (
        <footer className="relative bg-gray-800 " aria-labelledby="footerHeading">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                    ...
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    <li>
                                        <a href="/" className="text-base text-gray-100 hover:text-white">
                                            About
                </a>
                                    </li>
                                    <li>
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-300 xl:text-center">
                        © 2021 Acoustic. All rights reserved.
      </p>
                </div>
            </div>
        </footer>
